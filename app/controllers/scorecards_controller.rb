class ScorecardsController < ApplicationController
  ...
  def evaluate_access
    ...
    return if @peoples_assignment.present? && @competition.in_peoples_judging_window?(COMP_TIME_ZONE)
    return if @judge.present? && @competition.in_challenge_judging_window?(COMP_TIME_ZONE)
