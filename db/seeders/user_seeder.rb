  ...
  def self.create_users size
    size.times do |number|
      ...
      profile = Profile.create(
        ...
        twitter: "https://twitter.com/#{user.preferred_name}",
        github: "https://github.com/#{user.preferred_name}#{number}",
        team_status: Profile.team_statuses.keys.sample,
        website: "https://www.#{user.preferred_name}.com",
        linkedin: "https://www.linkedin.com/in/#{user.preferred_name}",
